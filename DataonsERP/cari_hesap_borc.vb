Public Class cari_hesap_borc
    ...
    Private Sub cari_hesap_borc_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
    ...
    Private Sub cari_hesap_borc_Load(sender As Object, e As EventArgs) Handles MyBase.Load
