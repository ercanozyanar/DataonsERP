Public Class cari_hesap_islem
    ...
    Private Sub cari_hesap_islem_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
    ...
    Private Sub cari_hesap_islem_Load(sender As Object, e As EventArgs) Handles MyBase.Load
