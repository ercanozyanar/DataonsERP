...
Public Class vezne_tanim
    ...
    Private Sub vezne_tanim_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.TopMost = True
        ...
        cmd2.CommandText = "SELECT* FROM vezne_tanim"
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        ...
        cmd1.CommandText = "INSERT INTO vezne_tanim (KOD,VEZNE_TANIM) VALUES ( '" & veznekodu.Text & "','" & vezneadi.Text & "')"
...
hata:
    ...
    Private Sub SimpleButton2_Click(sender As Object, e As EventArgs) Handles SimpleButton2.Click
        ...
        conn1.Open()
        cmd1.Connection = conn1
        cmd1.CommandText = "Delete From vezne_tanim where ID='" & silid & "'"
        cmd1.ExecuteNonQuery()
        '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        conn1.Close()
        '---------------------------------------------------------------------------------------------------
